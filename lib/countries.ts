...
export const COUNTRIES: Country[] = [
  { name: "Afghanistan", code: "AF", currency: "AFN", symbol: "Af" },
  ...
  { name: "Congo (Congo-Brazzaville)", code: "CG", currency: "XAF", symbol: "Fr" },
  { name: "Congo (Democratic Republic)", code: "CD", currency: "CDF", symbol: "Fr" },
  ...
  { name: "Czechia (Czech Republic)", code: "CZ", currency: "CZK", symbol: "Kč" },
  ...
  { name: "Myanmar (formerly Burma)", code: "MM", currency: "MMK", symbol: "Ks" },
  ...
  { name: "Uzbekistan", code: "UZ", currency: "UZS", symbol: "сўм" },
