-- 1. Add image_url to menu_categories if missing
...
-- 3. Drop existing policies to allow clean recreation and avoid conflicts
...
drop policy if exists "Authenticated Insert Menu Images" on storage.objects;
...
-- 5. Allow authenticated users to do ANYTHING (Insert, Update, Delete) in this bucket
